...
class AuthorisationWindow(QtWidgets.QMainWindow, Ui_AuthorisationWindow):
    ...
    def __sign_up(self):
        ...
        if (self.user_id is None):
            ...
            self.invalid_auth_label.hide()
            window = CustomerWindow(app_widget=self.app_widget, customer_id=self.user_id, customer_username=username)
    ...
    def __register(self):
        window = RegistrationWindow(app_widget=self.app_widget)
        self.username_line_edit.setText('')
        self.password_line_edit.setText('')
