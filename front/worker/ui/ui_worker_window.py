...
class Ui_WorkerWindow(object):
    def setupUi(self, WorkerWindow):
        ...
        self.status_filter_comboBox.setGeometry(QtCore.QRect(770, 40, 161, 31))
        ...
        self.date_filter_comboBox.setGeometry(QtCore.QRect(940, 40, 211, 31))
        self.date_filter_comboBox.setObjectName("date_filter_comboBox")
        self.date_filter_label = QtWidgets.QLabel(self.orders_tab)
        self.date_filter_label.setGeometry(QtCore.QRect(940, 20, 81, 21))
        ...
        self.worker_tab_widget.setCurrentIndex(1)
    ...
    def retranslateUi(self, WorkerWindow):
        ...
        self.date_filter_label.setText(_translate("WorkerWindow", "Filter by date:"))
